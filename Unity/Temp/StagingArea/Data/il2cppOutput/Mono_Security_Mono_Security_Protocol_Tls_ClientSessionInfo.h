...
struct  ClientSessionInfo_t609  : public Object_t
{
	...
	ByteU5BU5D_t378* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t378* ___masterSecret_5;
};
struct ClientSessionInfo_t609_StaticFields{

...
extern "C" void Array__ctor_m592 (Array_t92 * __this, const MethodInfo* method)
{
	{
...
extern "C" Object_t * Array_Coerce_m1652 (Array_t92 * __this, Type_t * ___toType, const MethodInfo* method)
{
	Array_t * G_B3_0 = {0};
	{
	...
	}
	{
		...
		Array_t * L_4 = Array_ToBuiltin_m1653(__this, L_3, /*hidden argument*/NULL);
		G_B3_0 = L_4;
		goto IL_001d;
	}
...
extern "C" Array_t * Array_ToBuiltin_m1653 (Array_t92 * __this, Type_t * ___type, const MethodInfo* method)
{
	{
		ArrayList_t71 * L_0 = CollectionBase_get_InnerList_m1659(__this, /*hidden argument*/NULL);
		Type_t * L_1 = ___type;
...
extern "C" String_t* Array_ToString_m1654 (Array_t92 * __this, const MethodInfo* method)
{
	...
	{
		String_t* L_0 = Array_Join_m1655(__this, _stringLiteral331, /*hidden argument*/NULL);
		return L_0;
	}
}
// System.String UnityScript.Lang.Array::Join(System.String)
extern "C" String_t* Array_Join_m1655 (Array_t92 * __this, String_t* ___seperator, const MethodInfo* method)
{
	{
		ArrayList_t71 * L_0 = CollectionBase_get_InnerList_m1659(__this, /*hidden argument*/NULL);
		String_t* L_1 = ___seperator;
		String_t* L_2 = Builtins_join_m1660(NULL /*static, unused*/, L_0, L_1, /*hidden argument*/NULL);
		return L_2;
	}
}
// System.Object UnityScript.Lang.Array::get_Item(System.Int32)
extern "C" Object_t * Array_get_Item_m595 (Array_t92 * __this, int32_t ___index, const MethodInfo* method)
{
	{
		ArrayList_t71 * L_0 = CollectionBase_get_InnerList_m1659(__this, /*hidden argument*/NULL);
...
extern "C" void Array_set_Item_m600 (Array_t92 * __this, int32_t ___index, Object_t * ___value, const MethodInfo* method)
{
	{
		...
		Array_EnsureCapacity_m1657(__this, ((int32_t)((int32_t)L_0+(int32_t)1)), /*hidden argument*/NULL);
		ArrayList_t71 * L_1 = CollectionBase_get_InnerList_m1659(__this, /*hidden argument*/NULL);
...
extern "C" void Array_OnValidate_m1656 (Array_t92 * __this, Object_t * ___newValue, const MethodInfo* method)
{
	{
		return;
	}
...
extern "C" void Array_EnsureCapacity_m1657 (Array_t92 * __this, int32_t ___capacity, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
...
IL_0011:
	...
	}
	{
		...
		ArgumentOutOfRangeException__ctor_m1661(L_5, _stringLiteral332, /*hidden argument*/NULL);
...
IL_0033:
	{
		...
		ArrayList_t71 * L_8 = CollectionBase_get_InnerList_m1659(__this, /*hidden argument*/NULL);

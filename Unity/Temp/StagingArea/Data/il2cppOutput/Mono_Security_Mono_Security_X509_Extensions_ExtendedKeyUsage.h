...
struct  ExtendedKeyUsageExtension_t633  : public X509Extension_t540
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t71 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t633_StaticFields{
	...
	Dictionary_2_t35 * ___U3CU3Ef__switchU24map14_4;
};
